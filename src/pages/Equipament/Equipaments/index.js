...
export default function Equipaments({ route }) {
  ...
  function navigateToNewEquipament() {
    navigation.navigate("NewModel", {
      ...
      returnScreen: !!returnScreen ? returnScreen : "Equipaments",
      returnData,
      lastScreen,
    });
  }
    ...
    <View style={mainStyle.containerDrawer}>
      <ScrollView style={styles.content}>
        ...
        <View style={styles.searchView}>
          <Text style={styles.searchHeader}> Modelos</Text>
        </View>
        <SearchBar
          screen="EditModel"
          urlLastFive={"/models/lastFive"}
          urlSearch={`/models/search${queryParams}`}
          editable={true}
        />
      </ScrollView>

      <View style={styles.insertView}>
        <Text style={styles.insertText}>Novo Modelo</Text>
        <TouchableOpacity
          style={styles.insertButton}
          onPress={() => {
            navigateToNewEquipament();
          }}
        >
